...
{
    public class MoviesInitializers
    {

        public static void Initialize(MoviesContext context)
        {
            var initializer = new MoviesInitializers();
            initializer.SeedEverything(context);
        }

        public void SeedEverything(MoviesContext context)
        {
        ...
        public void SeedDirectors(MoviesContext context)
        {
            var directors = new[]
            {
                new Director()
        ...
        public void SeedMovies(MoviesContext context)
        {
            var movies = new[]
            {
                new Movie
